...
CREATE OR REPLACE FUNCTION public.save_property(_id uuid DEFAULT NULL, _property jsonb DEFAULT NULL, _amenities uuid[] DEFAULT NULL, _images jsonb DEFAULT NULL)
