...
import { Eye, Trash2, LogOut, Users, X, RefreshCw } from "lucide-react";
...
const AdminDashboard = () => {
  ...
  return (
    <>
      <SEOHead
        title="Dashboard | EverySpaces Admin"
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      ...
                      >
                        {deletingId === lead.id ? (
                          <span className="h-3.5 w-3.5 border-2 border-destructive/30 border-t-destructive rounded-full animate-spin block" />
                        ) : (
                          <Trash2 size={15} />
                        )}
                      </button>
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-2.5">
                    {lead.team_size && (
                      <span className="text-[10px] bg-secondary/50 text-secondary-foreground px-2 py-0.5 rounded-full">
                    ...
                    {lead.planned_timeline && (
                      <span className="text-[10px] bg-primary/5 text-primary px-2 py-0.5 rounded-full">
                        {lead.planned_timeline}
                      </span>
                    )}
                  </div>
              ...
              >
                ...
                <div className="px-5 pb-5">
                  <button
                    ...
                    className="w-full py-2.5 rounded-full bg-destructive text-destructive-foreground text-sm font-medium hover:bg-destructive/90 transition-colors flex items-center justify-center gap-2"
                  >
                    <Trash2 size={14} />
                    Delete Lead
                  </button>
