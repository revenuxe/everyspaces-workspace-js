...
export const cityContent: Record<string, CityLanding> = {
  bangalore: {
    ...
    citySlug: "bangalore",
    state: "Karnataka",
    metaTitle: "Best Coworking & Office Space in Bangalore | Numunix",
    metaDescription: "Find affordable coworking spaces, private offices & managed workspaces across Bangalore. Premium office space for rent in Koramangala, Whitefield, HSR Layout, Indiranagar & more. Numunix workspace solutions.",
    ...
    goalsHeading: "Why Teams in Bangalore Choose Numunix",
    testimonial: {
      quote: "Numunix helped us find the ideal office in Koramangala within a week. Their local expertise in Bangalore's commercial market is unmatched — we couldn't have done it without them!",
      name: "Rahul Krishnan",
      initials: "RK",
