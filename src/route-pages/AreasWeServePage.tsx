      ...
      <AnimatedSection>
        <InternalLinksSection
          ...
          links={[
            ...
            {
              href: "/listings",
              title: "All Workspace Listings",
              description: "Switch from location research to actual available inventory with filtering by price and seats.",
            },
            {
              href: "/contact",
