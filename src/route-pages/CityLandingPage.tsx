      ...
      <section className="relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 -mt-16 sm:-mt-20 relative z-20">
          <div className="rounded-lg sm:rounded-2xl overflow-hidden shadow-2xl">
            <Image src={heroImg} alt={`Office space and coworking in ${content.city}`} priority sizes="(max-width: 640px) 100vw, (max-width: 1024px) 90vw, 1200px" className="w-full h-[200px] sm:h-[300px] md:h-[500px] object-cover" />
          </div>
        ...
        <section className="py-12 md:py-20 px-4 sm:px-6 lg:px-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="relative rounded-none overflow-hidden min-h-[300px] sm:min-h-[400px]">
              <Image src={testimonialBg} alt={`Workspace in ${content.city}`} fill sizes="(max-width: 1024px) 100vw, 1200px" className="object-cover" />
