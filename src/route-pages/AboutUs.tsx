    ...
    <div className="min-h-screen bg-background">
      ...
      <AnimatedSection delay={0.1}>
        <InternalLinksSection
          ...
          title="See How We Help Teams Find the Right Workspace"
          description="These pages connect our company story to the locations, listings, and consultation paths people usually explore next."
          links={[
            {
              href: "/listings",
            ...
            },
            {
              ...
              title: "Bangalore Workspace Guide",
              description: "See our office space and coworking coverage across Bangalore's top commercial areas.",
            },
            {
              href: "/contact",
              title: "Talk to Our Team",
              description: "Start a workspace search with a direct consultation for your team size, budget, and location goals.",
            },
          ]}
        />
      </AnimatedSection>
      ...
      <AnimatedSection delay={0.1}>
        <section className="px-4 pb-8 sm:px-6 lg:px-12">
          <div className="mx-auto max-w-5xl rounded-2xl border border-border bg-secondary px-5 py-4 text-center">
