...
const TermsConditions = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="Terms & Conditions – Numunix | Service Agreement & Policies"
        description="Review Numunix' terms and conditions covering service fees, payment methods, liability, and workspace consulting policies. Transparent terms for all clients."
        canonical="/terms-and-conditions"
        keywords="Numunix terms and conditions, service agreement, office brokerage fees, workspace consulting terms, payment policy"
      />
      <Navbar />
      <AnimatedSection>
        ...
        <section className="py-14 md:py-20 px-4 sm:px-6 lg:px-12">
          <div className="max-w-3xl mx-auto prose-sm sm:prose text-foreground">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              By accessing or using the Numunix website and services ("Services"), you agree to be bound by these Terms and Conditions ("Terms"). If you do not agree to these Terms, please do not use our Services. These Terms constitute a legally binding agreement between you and Numunix.
            </p>

            <h2 className="text-xl sm:text-2xl font-serif mb-4">2. Description of Services</h2>
            <p className="text-muted-foreground text-sm leading-relaxed mb-2">Numunix provides workspace consulting, search, and management services including but not limited to:</p>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              All content on the Numunix website — including text, graphics, logos, images, designs, layouts, and software — is the property of Numunix and is protected by Indian and international intellectual property laws. You may not copy, modify, distribute, sell, or create derivative works from any content without our express written permission.
            </p>

            <h2 className="text-xl sm:text-2xl font-serif mb-4">5. Service Disclaimer</h2>
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              Numunix provides workspace recommendations and advisory services on a best-effort basis. We do <strong>not</strong> guarantee the availability, pricing, condition, or suitability of any workspace or property. All workspace listings, market data, and property information are provided "as is" and may change without notice. We recommend independent verification of all property details before making any commitments.
            </p>

            <h2 className="text-xl sm:text-2xl font-serif mb-4">6. Limitation of Liability</h2>
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              To the fullest extent permitted by law, Numunix, its directors, employees, and affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of our Services, including but not limited to loss of profits, business interruption, data loss, or damages resulting from reliance on workspace recommendations. Our total liability for any claim shall not exceed the fees paid by you for the specific service giving rise to the claim.
            </p>

            <h2 className="text-xl sm:text-2xl font-serif mb-4">7. Third-Party Services & Links</h2>
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              Our Services may involve interactions with third-party workspace providers, property owners, or service vendors. Numunix is not a party to any agreement you enter into with third parties and is not responsible for their actions, services, or policies. Any links to third-party websites are provided for convenience only and do not constitute endorsement.
            </p>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-4">
              Numunix charges a <strong>one-time brokerage fee equivalent to one (1) month's rent</strong> of the rented office space. This fee is payable upon successful completion of the workspace deal — i.e., when the lease or rental agreement is signed between the client and the property owner/provider.
            </p>
            ...
            <ul className="list-disc pl-5 text-muted-foreground text-sm leading-relaxed mb-4 space-y-1">
              <li><strong>Bank Transfer (NEFT/RTGS/IMPS):</strong> Direct transfer to Numunix' designated bank account</li>
              <li><strong>UPI:</strong> Payment via Google Pay, PhonePe, Paytm, or any UPI-enabled app</li>
              <li><strong>Cheque:</strong> Demand draft or account payee cheque in favour of Numunix</li>
              <li><strong>Online Payment:</strong> Via payment link shared by Numunix (credit/debit card supported)</li>
              <li><strong>Cash:</strong> Accepted in exceptional cases with a proper receipt issued by Numunix</li>
            </ul>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              The brokerage fee is <strong>non-refundable</strong> once the lease/rental agreement has been signed. If a deal falls through before signing due to reasons attributable to Numunix, a full refund of any advance payment will be provided. Numunix reserves the right to modify its fee structure with reasonable prior notice for future engagements.
            </p>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              You agree to indemnify, defend, and hold harmless Numunix and its officers, directors, employees, and agents from any claims, damages, losses, liabilities, costs, or expenses (including legal fees) arising from your use of the Services, violation of these Terms, or infringement of any third-party rights.
            </p>

            <h2 className="text-xl sm:text-2xl font-serif mb-4">11. Termination</h2>
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              Numunix reserves the right to suspend or terminate your access to the Services at any time, with or without cause, and without prior notice. Upon termination, all provisions of these Terms that should reasonably survive — including intellectual property, limitation of liability, indemnification, and governing law — shall remain in effect.
            </p>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              Numunix shall not be liable for any failure or delay in performing our obligations due to circumstances beyond our reasonable control, including but not limited to natural disasters, pandemics, government actions, cyber attacks, or infrastructure failures.
            </p>
