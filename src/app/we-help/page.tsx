...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Numunix helps startups and businesses find coworking spaces, managed offices, plug-and-play offices, and independent commercial office properties across Bengaluru with expert shortlisting and leasing support.",
  path: "/we-help",
  keywords:
