...
const TestimonialSection = () => {
  return (
    <section id="testimonial" className="py-16 md:py-24 px-4 sm:px-6 lg:px-12">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif text-center mb-8 md:mb-12">
          Real teams. Better workspace decisions.
        </h2>

        <div className="relative rounded-2xl overflow-hidden min-h-[300px] sm:min-h-[400px]">
          <img
          ...
          <div className="relative z-10 flex items-center justify-center min-h-[300px] sm:min-h-[400px] p-4 sm:p-8">
            <div className="bg-card rounded-2xl p-6 sm:p-8 max-w-xl shadow-xl w-full sm:w-auto">
              ...
              <p className="text-foreground text-base sm:text-lg leading-relaxed mb-8">
                "Numunix helped us find the ideal office in Koramangala within a week. Their local expertise in Bangalore's commercial market is unmatched — we couldn't have done it without them!"
              </p>
