    ...
    >
      <div className="bg-card border border-border rounded-2xl shadow-lg p-6 sm:p-8 md:p-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 md:gap-8 pt-6 md:pt-8 border-t border-border">
          ...
          <Link to={`/services/${slug}`} className="flex items-center justify-between border border-foreground text-foreground font-semibold text-sm py-3 pl-5 pr-3 rounded-full hover:bg-foreground hover:text-primary-foreground transition-colors md:w-fit md:gap-4 shrink-0">
            <span>View Detailed Page</span>
            <span className="w-8 h-8 rounded-full border-2 border-current/30 flex items-center justify-center ml-3"><ArrowUpRight size={14} /></span>
          </Link>
        </div>
      </div>
    </motion.div>
